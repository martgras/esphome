...
enum RHT_Acceleration_Mode : uint16_t { LOW_ACCELERATION = 0, MEDIUM_ACCELERATION = 1, HIGH_ACCELERATION = 2 };
...
class SEN5XComponent : public PollingComponent, public i2c_sensirion::SensirionI2CDevice {
 public:
  ...
  enum Sen5xType { SEN55, SEN54, SEN50 };
  ...
  void set_acceleration_mode(RHT_Acceleration_Mode mode) { acceleration_mode_ = mode; }
 ...
 protected:
  ...
  optional<RHT_Acceleration_Mode> acceleration_mode_;
