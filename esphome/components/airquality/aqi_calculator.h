...
class AQICalculator : public AbstractAQICalculator {
 ...
 protected:
  ...
  const int calculation_grids_[(Pollutant::SO2 + 1)][AMOUNT_OF_LEVELS][2] = {
      // pm2_5 24h avg
      {{0, 12}, {13, 35}, {36, 55}, {56, 150}, {151, 250}, {251, 350}, {351, 0x7FFF}},
      // PM 10 24h avg
      {{0, 54}, {55, 154}, {155, 254}, {255, 354}, {355, 424}, {425, 504}, {425, 0x7FFF}},
      // No2 1h avr
      {{0, 53}, {54, 100}, {101, 360}, {361, 649}, {650, 1249}, {1250, 1649}, {1650, 0x7FFF}},
      //  o3  not exaclty correct AQI uses 8h and 1h avg for
      {{0, 54}, {55, 124}, {125, 164}, {165, 204}, {205, 404}, {405, 504}, {505, 0x7FFF}},
      // CO - 8h avg
      {{0, 4}, {5, 9}, {10, 12}, {13, 14}, {15, 30}, {31, 40}, {41, 0x7FFF}},
      // SO2 1h avg
      {{0, 35}, {36, 75}, {76, 185}, {186, 304}, {305, 604}, {605, 804}, {805, 0x7FFF}}};
