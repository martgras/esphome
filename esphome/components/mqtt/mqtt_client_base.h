...
class MqttClientBase {
 public:
  ...
  virtual void set_credentials(const char *username, const char *password = nullptr) = 0;
  virtual void set_will(const char *topic, uint8_t qos, bool retain, const char *payload = nullptr,
                        size_t length = 0) = 0;
